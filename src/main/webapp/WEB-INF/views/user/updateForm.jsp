...
<div class="container">
	...
	<c:if test="${principal.user.auth=='Member'}">
		<div class="form-group">
			<label for="originalPassword">Original Password</label> <input type="password" class="form-control" placeholder="Enter Original Password" id="originalPassword">
		</div>
	
	<div class="form-group">
		<label for="newPassword">New Password</label> <input type="password" class="form-control" placeholder="Enter New Password" id="newPassword">
	</div>
